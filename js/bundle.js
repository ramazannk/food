...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _server__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../server */ "./js/server.js");
...
const card =()=>{
    ...
    (0,_server__WEBPACK_IMPORTED_MODULE_0__.getResource)('http://localhost:3000/menu')
        .then(data => {
...
/* harmony import */ var _server__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../server */ "./js/server.js");
...
const forms = (formSelector, modalTimerId) =>{
    ...
    function bindPostData(form) {
        form.addEventListener('submit', (e) => {
            ...
            (0,_server__WEBPACK_IMPORTED_MODULE_1__.postData)('http://localhost:3000/requests', json)
            .then(data => {
                console.log(data);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (timerModul);
...
/* harmony import */ var _modules_calck__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/calck */ "./js/modules/calck.js");
...
window.addEventListener('DOMContentLoaded', function() {
    ...
    const modalTimerId = setTimeout(()=>(0,_modules_modalWind__WEBPACK_IMPORTED_MODULE_2__.openModal)('.modal', modalTimerId), 300000);
    ...
    (0,_modules_calck__WEBPACK_IMPORTED_MODULE_6__["default"])();
